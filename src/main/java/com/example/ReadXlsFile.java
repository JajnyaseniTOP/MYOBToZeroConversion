...
public class ReadXlsFile {
	...
	public static void main(String[] args) {
		...
		String filePath = "C://Users/Jajnyaseni TOP/Documents/Deliverables/The Classic Motor Hub Pty Ltd/The Classic Motor Hub Pty Ltd - Fixed Asset Schedule (2023).xls";
...
for (i = 0; i < data.length; i++) {
        ...
        String filePath = "C://Users/Jajnyaseni TOP/Downloads/"+fileName.split(".xls")[0]+" - output.csv";
